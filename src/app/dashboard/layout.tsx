    ...
    return (
        ...
        >
            ...
            <div className="flex flex-1">
                <div className="p-2 mr-2 md:p-10 rounded-2xl border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 flex flex-col gap-2 flex-1 w-full h-full">
                    {children}
                </div>
            </div>
            <div className="fixed flex gap-2 top-10 right-10 py-1 px-2 justify-center items-center z-20 bg-gray-400 rounded-full bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10 border border-netural-200 dark:border-neutral-700 dark:bg-neutral-900">
                <ModeToggle />
                <div className="bg-white dark:bg-neutral-900 rounded-full p-1">
                    <ProfileButton />
                </div>
            </div>
        </div>
