...
export function ProfileForm({ onComplete, isDrawer = false }: ProfileFormProps) {
    ...
    if (loading) {
        return (
            <Card className={isDrawer ? "border-0 shadow-none" : "w-full"}>
                <CardHeader className={isDrawer ? "px-0" : ""}>
        ...
        <Card className={isDrawer ? "border-0 shadow-none" : "w-full"}>
            {!isDrawer && (
                <CardHeader>
                    ...
                    <CardDescription className="text-center">Complete your profile information to get started</CardDescription>
                </CardHeader>
            )}
            <Form {...form}>
